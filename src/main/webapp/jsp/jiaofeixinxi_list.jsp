...
<script type="text/javascript" src="js/My97DatePicker/WdatePicker.js" charset="gb2312"></script>
    ...
    <td>${jiaofeixinxi.riqi}</td>
					...
					<td  align="center" width="200px">
						     <input type="button" value="删除" onclick="jiaofeixinxiDel(${jiaofeixinxi.id})"/>
						     <input type="button" value="编辑" onclick="jiaofeixinxiPre(${jiaofeixinxi.id})"/>
							 
							 <input type="button" value="详细" onclick="jiaofeixinxiDetail(${jiaofeixinxi.id})"/>
					</td>
				</tr>
				</c:forEach>
			</table>
