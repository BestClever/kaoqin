...
<script type='text/javascript' src='dwr/util.js'></script>
        ...
        <script language="javascript">
           ...
           function liuyanbanPrelb(id)
           {
                   window.location.href="liuyanbanPrelb.action?id="+id;
           }
		    function liuyanbanPre(id)
           {
                   window.location.href="liuyanbanPre.action?id="+id;
           }
		   function liuyanbanUpdtlb(id)
           {
                   window.location.href="liuyanbanUpdtlb.action?id="+id;
           }
    ...
    <td>${liuyanban.huifuneirong}</td>
					...
					<td  align="center">
						     ...
						     <input type="button" value="回复" onclick="liuyanbanPrelb(${liuyanban.id})"/>
					</td>
				</tr>
				</c:forEach>
			</table>
