...
<dl class="custom">
			...
			<dd><a href="xueshengPre2.action" target="hsgmain">修改个人资料</a></dd>

		</dl>
<dl class="custom">
			<dt onClick="changeImage()">缴费管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="jiaofeixinxiList2.action" target="hsgmain">缴费信息查看</a></dd>
<dd><a href="jiaofeijiluList2.action" target="hsgmain">缴费记录查询</a></dd>
