...
<%@ include file="sidebufen2.jsp"%>
  <div class="layout bg6">
    <div class="lei_mian">
      <h3><a href="index.action">首页</a> > 内容详细</h3>
    </div>
  </div>
<div style="width:1200px; margin:0 auto;">
	 ...
	 <table width="97%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#B8D8E8" class="newsline" style="border-collapse:collapse">
                            <tr>
                              <td height="33" align="center"><span class="STYLE1"><s:property value="#request.ggdetail.biaoti"/> (被点击<s:property value="#request.ggdetail.dianjilv"/>次)</span></td>
                            </tr>
                            <tr>
